/**
 * Swiggy API Utility Module
 * This module contains shared functionality for reading location data and calling Swiggy APIs.
 * Used by both store SLA check and item availability check cron jobs.
 */
...
/**
 * Calls the Swiggy API for a specific lat/lng to get store serviceability data
 * @param {Object} location - The location object with lat and lng
 * @returns {Promise<Object>} The API response with store serviceability data
 */
